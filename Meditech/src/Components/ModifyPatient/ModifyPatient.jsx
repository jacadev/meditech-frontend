      ...
      <Box display="flex" alignItems="center">
        <Box flex="1" borderRadius="10px" padding="20px" boxShadow="lg">
          ...
          <Box marginTop="20px">
            <Text
              fontSize="16px"
              color={infoPatient.person?.status ? "green" : "red"}
            >
      ...
      <Box marginTop="20px">
        ...
        {infoPatient.reviews?.map((review, index) => (
          ...
          >
            ...
            <Text fontSize="16px" color={review.status ? "green" : "red"}>
              Estado: {review.status ? "activo" : "inactivo"}
            </Text>

            <Button
              onClick={() => changeHandlerReview(review.id, review.status)}
              marginTop="10px"
              bg="blue"
              color="white"
              focusOutline="none"
